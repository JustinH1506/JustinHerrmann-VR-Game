Shader "Custom/HolographicScanlinesSprite"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Disable culling so we can see both sides of the sprite
            Cull Off
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                // Use the alpha channel of the texture to control transparency
                if (texColor.a < 0.1)
                {
                    discard;  // Skip fragments with low alpha (transparent)
                }

                // Blend the scanline effect with the base texture color
                ...
                // Apply glow effect (optional), based on the texture's color
